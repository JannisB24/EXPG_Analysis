...
n_control <- sum(module_data$module_matching.1.group.treatment == 0) * 2
n_treatment <- sum(module_data$module_matching.1.group.treatment == 1) * 2
...
c_1_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 0] == 1) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 0] == 1)) / n_control * 100
c_2_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 0] == 2) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 0] == 2)) / n_control * 100
c_3_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 0] == 3) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 0] == 3)) / n_control * 100
c_4_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 0] == 4) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 0] == 4)) / n_control * 100
c_5_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 0] == 5) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 0] == 5)) / n_control * 100

t_1_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 1] == 1) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 1] == 1)) / n_treatment * 100
t_2_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 1] == 2) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 1] == 2)) / n_treatment * 100
t_3_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 1] == 3) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 1] == 3)) / n_treatment * 100
t_4_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 1] == 4) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 1] == 4)) / n_treatment * 100
t_5_pc <- (sum(module_data$WPM1_Prio[module_data$module_matching.1.group.treatment == 1] == 5) 
           + sum(module_data$WPM2_Prio[module_data$module_matching.1.group.treatment == 1] == 5)) / n_treatment * 100
